...
/**
  ...
  `})({expected:t.expected,time_to_station_normal_mins:e,time_to_station_rush_mins:n,ideal_mins_waiting_at_station:i})}
    ...
    <div class="column-3 font-black text-xl">
      ${(t=>{const e=Math.floor((new Date(t).getTime()-(new Date).getTime())/1e3);return F`
    <div class="text-xl font-black">
      ${(t=>{const e=_t(Math.floor(t/3600)),n=_t(Math.floor(t%3600/60)),i=_t(t%60);return"-1"===e?"Gone":"00"===e&&"00"===n?F`${i}`:"00"===e?F`${n}:${i}`:F`${e}:${n}:${i}`})(e)}
    </div>
  `})(t.expected)}
    </div>

    <div class="column-4 font-black text-xl ${"1"===t.platform?"text-green-500":"text-red-500"}">
      ${t.platform}
    </div>
  ...
  `:F``)({title:(()=>{var t;return this._title?this._title:(null===(t=this._train_entity)||void 0===t?void 0:t.friendly_name)?this._train_entity.friendly_name:this._train_schedule?this._train_schedule.entity_id:"Pick a train station"})(),time:this._time,show_title:this._show_title,show_clock:this._show_clock});return this._train_schedule?this._train_schedule.attributes?this._train_schedule.attributes.trains&&0!==this._train_schedule.attributes.trains.length?F`<ha-card>
      <div class="w-100 grid grid-cols-4 gap-2 p-4 text-left">
        ...
        ${null===(t=this._train_schedule)||void 0===t?void 0:t.attributes.trains.map((t=>"Cancelled"===t.expected?F`
              <div class="text-xl text-red-500 font-black col-span-4">
                <div class="line-through">
                  ${ut(t.scheduled,!1)} Cancelled
                </div>
              </div>
            `:mt({train:t,time_to_station_normal_mins:this._time_to_station_normal_mins,time_to_station_rush_mins:this._time_to_station_rush_mins,ideal_mins_waiting_at_station:this._ideal_mins_waiting_at_station,show_terminates_at:this._show_terminates_at})))}
      </div>
    </ha-card> `:F`<ha-card>
        ...
        ${gt("No train schedule attributes.")}
      </ha-card>`:F`<ha-card>
        ${gt("No train schedule object.")}
      </ha-card>`}}ft.styles=l`${a(pt)}`,e([dt()],ft.prototype,"_title",void 0),e([dt()],ft.prototype,"_train_schedule",void 0),e([dt()],ft.prototype,"_train_entity",void 0),e([dt()],ft.prototype,"_time",void 0);const wt=({id:t,value:e,label:n,change:i})=>F`
    ...
    `,bt=({id:t,value:e,label:n,change:i})=>F`
      <ha-textfield
        id="${t}"
        class="flex-1"
        type="number"
