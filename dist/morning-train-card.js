...
/**
    ...
    <div>
      ...
      ${(t=>{const e=gt(Math.floor(t/3600)),n=gt(Math.floor(t%3600/60)),i=gt(t%60);return"-1"===e?"Gone":"00"===e&&"00"===n?q`${i}`:"00"===e?q`${n}:${i}`:q`${e}:${n}:${i}`})(e)}
      </span>
    </div>
