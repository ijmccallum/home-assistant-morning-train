...
/**
    ...
    <div>
      ...
      ${(t=>{const e=_t(Math.floor(t/3600)),n=_t(Math.floor(t%3600/60)),i=_t(t%60);return"-1"===e?"Gone":"00"===e&&"00"===n?q`${i}`:"00"===e?q`${n}:${i}`:q`${e}:${n}:${i}`})(e)}
      </span>
    </div>
  ...
  `:q``)({title:(()=>{var t;return this._title?this._title:(null===(t=this._train_entity)||void 0===t?void 0:t.friendly_name)?this._train_entity.friendly_name:this._train_schedule?this._train_schedule.entity_id:"Pick a train station"})(),time:this._time,show_title:this._show_title,show_clock:this._show_clock});return this._train_schedule?this._train_schedule.attributes?this._train_schedule.attributes.trains&&0!==this._train_schedule.attributes.trains.length?(console.log("4"),q`<ha-card>
      <div class="w-100 grid grid-cols-2 gap-8 p-4">
        ...
        ${null===(t=this._train_schedule)||void 0===t?void 0:t.attributes.trains.map((t=>"Cancelled"===t.expected?q`
            ...
            `:gt({train:t,time_to_station_normal_mins:this._time_to_station_normal_mins,time_to_station_rush_mins:this._time_to_station_rush_mins,show_terminates_at:this._show_terminates_at})))}
      </div>
    </ha-card> `):q`<ha-card>
        <div class="w-100 grid grid-cols-2 gap-8 p-4">
          ${e}
      ...
      </ha-card>`}}ft.styles=l`${a(pt)}`,e([dt()],ft.prototype,"_title",void 0),e([dt()],ft.prototype,"_train_schedule",void 0),e([dt()],ft.prototype,"_train_entity",void 0),e([dt()],ft.prototype,"_time",void 0);const bt=({id:t,value:e,label:n,change:i})=>q`
    ...
    `,wt=({id:t,value:e,label:n,change:i})=>q`
      <ha-textfield
        id="${t}"
        class="flex-1"
        type="number"
  ...
  `:q`
    ...
    `)({name:"element_id",label:"Entity to Show",hass:this.hass,change:this._change,value:null!==(t=this._config.element_id)&&void 0!==t?t:""})}
      ...
      ${wt({change:this._change,label:"Relaxed pace",id:"time_to_station_normal_mins",value:null!==(e=this._config.time_to_station_normal_mins)&&void 0!==e?e:""})}
      ${wt({change:this._change,label:"When you're in a rush",id:"time_to_station_rush_mins",value:null!==(n=this._config.time_to_station_rush_mins)&&void 0!==n?n:""})}
      <div class="col-span-2 pt-3">
        ${bt({id:"show_terminates_at",value:this._config.show_terminates_at,label:"Show Terminates at?",change:this._change})}
      </div>
